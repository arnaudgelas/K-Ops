...
Answer file: a timestamped file under notes/Answers/
...
Read `a timestamped file under notes/Answers/` first. If the answer section no longer contains `__ANSWER_PENDING__`, the question has already been answered — print the file path and stop. Do not overwrite a completed answer.
...
Replace `__ANSWER_PENDING__` in `a timestamped file under notes/Answers/` with your answer. Keep the rest of the scaffold intact.
...
- [ ] `a timestamped file under notes/Answers/` no longer contains `__ANSWER_PENDING__`.

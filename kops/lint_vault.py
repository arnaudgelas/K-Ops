...
from kops.utils import CONFIG, ROOT, find_source_note, parse_frontmatter
...
def lint_vault(
    ...
    if check:
        try:
            ...
            from kops.generate_indexes import (
                get_sources_data,
                get_concepts_data,
            ...
            if (
                ...
                or flat_concept_index_path.read_text(encoding="utf-8")
                != generated_flat_concept_index
            ):
                findings.append(
                    Finding(
                        "error",

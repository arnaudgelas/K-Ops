...
from kops.utils import CONFIG, ROOT, dump_frontmatter, parse_frontmatter
from kops.vault_scorecard import (
    SCORECARD_PATH,
...
def run_lint(*, strict: bool = False, fix_backlinks: bool = False, check: bool = False) -> None:
    from kops.lint_vault import lint_vault
...
def run_validate_config(strict: bool = False) -> None:
    ...
    if missing:
        raise SystemExit(1)
    if strict:
        from kops.kb_schema import run_strict_validation
